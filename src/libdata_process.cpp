...
void SYNC::ConfigData_SYNC(Data_Path *Data_Path_p,Function_EN *Function_EN_p,JSON_PIDConfigData *JSON_PIDConfigData_p)
{
    ...
    const std::vector<std::string> required_keys = {
        ...
        "MAX_BEND_POINT_ANGLE", "TRACK_WIDTH",         "TRACK_KIND_COUNT_THRESHOLD","CIRCLE_OUT_WIDTH", "TRACK_WIDTH_PERSPECTIVE_MIN", "TRACK_WIDTH_PERSPECTIVE_MAX", "TRACK_WIDTH_GUARD_MIN_PX", "STRIGHT_TRACK_MOTOR_SPEED",
    ...
    JSON_TrackConfigData.TrackWidthPerspectiveMin = ConfigData.at("TRACK_WIDTH_PERSPECTIVE_MIN");
    JSON_TrackConfigData.TrackWidthPerspectiveMax = ConfigData.at("TRACK_WIDTH_PERSPECTIVE_MAX");
    JSON_TrackConfigData.TrackWidthGuardMinPx = ConfigData.at("TRACK_WIDTH_GUARD_MIN_PX");
