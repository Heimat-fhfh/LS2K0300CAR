...
void DualMotorController::setPwmDeadZones(float leftDeadZone, float rightDeadZone) {
    leftMotor_->setPwmDeadZone(leftDeadZone);
    rightMotor_->setPwmDeadZone(rightDeadZone);
}
